/******************************************************************************/
/* Program : https://urldefense.com/v3/__http://stddiff.sas__;!!H9nueQsQ!9rZht_dZrAPm65bwHke-3RRDqFKxL2WcCEGtpooZC4un1mEM9FAQFtxJyniUkMJ9S1vv22xm5yTs2PrnryuX2i5AM0OFJOQ$ 
...
/* each column has one element of a S covariance matrix (k x k) */
			...
			data covdata_3; 
		   		...
		   		by gp id; 
		   		retain lp; 
		   		if https://urldefense.com/v3/__http://first.gp__;!!H9nueQsQ!9rZht_dZrAPm65bwHke-3RRDqFKxL2WcCEGtpooZC4un1mEM9FAQFtxJyniUkMJ9S1vv22xm5yTs2PrnryuX2i5A2ksmYNU$  then lp = 0; 
		   		lp = lp+1; 
		  	run; 
...
/* transpose to a S variance-covariance matrix format */
		  	...
		  	data covdata_4; 
		   		...
		   		by gp id; 
		   		if https://urldefense.com/v3/__http://first.gp__;!!H9nueQsQ!9rZht_dZrAPm65bwHke-3RRDqFKxL2WcCEGtpooZC4un1mEM9FAQFtxJyniUkMJ9S1vv22xm5yTs2PrnryuX2i5A2ksmYNU$  then do; 
		    		do k = 1 to &_k_.; 
		     			cy{k} = .; 
				    end; 
		   		end; 
		   		cy{lp} = col1; 
		   		if https://urldefense.com/v3/__http://last.gp__;!!H9nueQsQ!9rZht_dZrAPm65bwHke-3RRDqFKxL2WcCEGtpooZC4un1mEM9FAQFtxJyniUkMJ9S1vv22xm5yTs2PrnryuX2i5ATwbco-c$  then output; 
		   		keep y:; 
		  	run; 
